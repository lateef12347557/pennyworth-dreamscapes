...
const listings = [
  { img: p2, badge: "New", tone: "terracotta", title: "Magnolia Cottage", price: "$845K", addr: "Asheville, NC" },
  { img: p3, badge: "Hot", tone: "sage", title: "The Ridgeway", price: "$2.1M", addr: "Sausalito, CA" },
  { img: p1, badge: "New", tone: "terracotta", title: "Villa Sereno", price: "$3.4M", addr: "Ojai, CA" },
  { img: p2, badge: "Open", tone: "sage", title: "Birchwood Lane", price: "$1.05M", addr: "Hudson, NY" },
];
        ...
        <div className="mt-12 -mx-6 flex gap-5 overflow-x-auto px-6 pb-4 md:mx-0 md:grid md:grid-cols-2 md:px-0 md:pb-0 lg:grid-cols-4">
          {listings.map((l, i) => (
            <motion.a
              ...
              whileHover={{ y: -6 }}
              className="group relative w-[280px] shrink-0 overflow-hidden rounded-2xl bg-card shadow-card transition-shadow hover:shadow-bloom md:w-auto"
            >
